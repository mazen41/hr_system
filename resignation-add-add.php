...
$form_title = 'إضافة استقالة جديده';
$save_btn = 'حفظ';
...
if(isset($_GET['id'])){
	...
	if($st->rowCount() > 0){
		...
		$client_id = $row['Id'];
		$form_title = 'تعديل استقالة الموظف ';
    ...
    <div class="row">
			<div class="col-md-12">
                ...
                <div class="card-header"    style="background: aliceblue; cursor: pointer">
					<h4 class="card-title">تفاضيل الاستقالة</h4>
					...
					<div class="card-body p-3">
                       ...
                       <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="Due_date" class="form-control input-date"  placeholder="تاريخ الاستقالة" id="Due_date" autocomplete="off" value="<?=(!empty($row['DueDate'])? $row['DueDate'] : '' )?>" required>
