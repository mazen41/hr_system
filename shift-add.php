...
<div class="row">
<label class="col-form-label required" for="time_start">حدد تاريخ الفتره ووقت بداية الدوام وانتهاءه لكل فتره</label><br>
<button type="button" id="addshift_detail" class="btn btn-primary btn-lg" name="addshift_detail">
    إضافة تفاصيل 
</button>		
<table id="shift_info" class="table table-bordered mt-2" >
				<thead>
					<tr>
