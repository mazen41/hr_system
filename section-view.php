...
.bdanger{ border-right:0.3rem solid red; display:block;}
	...
	<?php endif;?>
					...
					<div class="card">
						<div class="card-header p-2 d-print-none with-nav-btn">
							...
							<div class=" btn-group dropdown-btn-group" style="direction:rtl">
								...
								قائمة الاعدادات</a>
								<a href="section-list" class="btn btn-default btn-white  btn-sm quick-action-btn">
								<span class="fa fa-list" aria-hidden="true"></span>
								قائمة الادارات</a>
								<?php
							if ($User->isAllowedPerm(['اضافة قسم'], $appid)) {   ?>
								<a href="section-add" class="btn btn-default btn-white  btn-sm quick-action-btn">
								<span class="fa fa-plus" aria-hidden="true"></span>
								إضافة ادارة جديد</a>
								<?php  } 
								if ($User->isAllowedPerm(['تعديل قسم'], $appid)) {   ?>
								<a href="section-add?id=<?=$row['Id']?>" class="btn btn-default btn-white  btn-sm quick-action-btn">
								<span class="fa fa-edit" aria-hidden="true"></span>
								تعديل</a>
								<?php  } 
								if ($User->isAllowedPerm(['حذف قسم'], $appid)) { ?>
			...
			<div class="card-body p-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" id="main-info-tab" data-toggle="pill" href="#main-info" role="tab" aria-controls="main-info" aria-selected="true"><strong>عن الادارة</strong></a>
              </li>            
			</ul>
