   <?php
if(!isset($_GET['id'])){
	echo'<script> location.replace("report-jobgrade"); </script>';
	die(); 
} 
$screen = 'الدرجات الوظيفية';
$page_title = 'تفاصيل الدرجة الوظيفية';
$report_name = 'تفاصيل الدرجة الوظيفية';
...
$query = " SELECT a.Id  ,b.branch_name,a.Name,a.CreatedDate, 
 u.FirstName , u.LastName,a.Description
FROM    tbljobgrade AS a
LEFT JOIN branches AS b ON a.BranchID = b.branch_id
LEFT JOIN tblusers AS u ON a.CreatedBy = u.UserID
where a.Id =:id
";
    ...
    if ($st->rowCount() > 0) {
        ...
        t.BranchID, t.SectionID, t.jobtitleID, t.GroupID, g.name as name_groub,t.GradeID,
...
/* 
	...
	<?php endif;?>
			...
			<div class="card-body p-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" id="main-info-tab" data-toggle="pill" href="#main-info" role="tab" aria-controls="main-info" aria-selected="true"><strong>عن الدرجة الوظيفية</strong></a>
              </li>            
			</ul>
			...
			<!-- start -->
                               ...
                               <div class="section">
            <div class="section-title">معلومات الدرجة الوظيفية</div>
            <table>
                <tbody><tr>
                    <td style="width: 25%; font-weight: bold;"> اسم الدرجة الوظيفية</td>
                ...
                <tr>
                    ...
                    <td colspan="3"><?= !empty($row['Description'])?$row['Description']:'غير محدد' ?></td>
        ...
        <div class="section">
            <div class="section-title">المضافين في هذه الدرجة الوظيفية</div>
            <table>
                <thead>
                    <tr>
                        <th style="width: 5%;">#</th>
...
function printData() {
    ...
    body {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>تقرير الدرجات الوظيفية</title>
                    ${styles}
                </head>
                <body>
                    ${printContents}
