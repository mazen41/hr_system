            ...
            },
            {
			  ...
			  render: function(data, type) {
                ...
                <?php if ($User->isAllowedPerm(['عرض قسم'], $appid)) { ?>
                    options += '<a href="section-view?id=' + data.id + '" type="button" class="dropdown-item view-pos about_account"><i class="fa fa-eye"></i> عرض</a>';
                <?php } ?>

                <?php if ($User->isAllowedPerm(['تعديل قسم'], $appid)) { ?>
                    options += '<a href="section-add?id=' + data.id + '" type="button" class="dropdown-item"><i class="fa fa-edit"></i> تعديل</a>';
                <?php } ?>
