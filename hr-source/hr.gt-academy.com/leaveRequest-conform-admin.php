...
function Search_leaves($connect, $id)
{
	...
	function Confrom($connect, $id) {
		...
		return false;
                ...
                {
                   $msg = 'يوجد لهذا الموظف اجازة بنفس  يوم من ايام الاجازة'; 
                }
...
<form class="form-horizontal" role="form" action="#" method="post" id="conform_incentive">
	<p class="text-danger"><b>هل ترغب بالفعل بتاكيد الاجازة</b>
...
$(document).ready(function(){
    ...
    $("#conform_incentive").on('submit', function(e){
        ...
        var form_data = $(this).serialize();
            $.ajax({
                url: 'hr-app/index.php?action=leaveRequest-conform-admin?confirme=1',
                type: 'POST',
                data:form_data,
                dataType:"json",
                beforeSend:function(){
