 <?php
if(!isset($_GET['id'])){
	echo'<script> location.replace("report-leaveclassficate"); </script>';
	die(); 
} 
$screen = 'الاجازات';
...
$report_name = 'تفاصيل الاجازة';
 ...
 if (isset($_GET['id'])) {
    ...
    $query = "SELECT a.Id, a.BranchID, a.Name, a.Description, a.isaccept,a.type, a.state, a.for_what, a.chose, a.AmountType,a.Amount ,
                     a.RequiresAttachment, a.CreatedBy, a.CreatedDate, u.FirstName, u.LastName, d.branch_name
    ...
    if ($st->rowCount() > 0) {
		...
		echo'<script> location.replace("incentive-leaveclassficate"); </script>';
		die();
	}
...
<?php  } ?>
      ...
      switch ($row['for_what']) {    case 1:   echo 'لموظف';    break;   case 2:   echo 'لمجموعة';    break;   case 3:   echo 'لدرجة وظيفية';    break;  case 4:   echo 'لمسمى وظيفي';  break; case 5:  echo 'لقسم محدد'; break; default: echo 'غير محدد'; break; }   ?></div>
        ...
        <div class="section">
            <div class="section-title">قائمة المضافين في الاجازة</div>
            <table>
                <thead>
                    <tr>
                        <th style="width: 5%;">#</th>
