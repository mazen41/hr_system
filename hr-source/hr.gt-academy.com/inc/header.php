...
<?php
    ...
    if (isset($_GET['dir'])) {
        $d = $_GET['dir'];
        if ($d === 'rtl' || $d === 'ltr') { $_SESSION['ui_dir'] = $d; $uiDir = $d; }
    }
...
<head>
    ...
    <meta property="og:image" content="<?= htmlspecialchars($siteUrl . '/dist/img/brand/logo-icon.png', ENT_QUOTES, 'UTF-8') ?>">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="<?= htmlspecialchars($metaTitle, ENT_QUOTES, 'UTF-8') ?>">
    <meta name="twitter:description" content="<?= htmlspecialchars($metaDescription, ENT_QUOTES, 'UTF-8') ?>">
    <meta name="twitter:image" content="<?= htmlspecialchars($siteUrl . '/dist/img/brand/logo-icon.png', ENT_QUOTES, 'UTF-8') ?>">
    <!-- PWA Meta Tags -->
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.18/dist/css/bootstrap-select.min.css" media="print" onload="this.media='all'">
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 991.98px) {
        ...
        .main-header .nav-link .bi { font-size: 18px; line-height: 1; }
        .main-header .user-menu-btn { padding: 6px 10px 6px 10px; gap: 8px; }
        .main-header .user-avatar { width: 28px; height: 28px; font-size: 13px; }
    }
    ...
    .nav-treeview .nav-item { margin: 2px 4px; }
    ...
    .nav-treeview .nav-icon { font-size: 10px !important; opacity: 0.7; }

    /* Treeview parent spacing */
    .nav-item.has-treeview { position: relative; overflow: visible; }
    .nav-item.has-treeview > .nav-link { cursor: pointer; }
    ...
    @media (max-width: 991.98px) {
        ...
        .container-fluid { 
            ...
            padding-right: 15px;
            max-width: 100%;
            overflow-x: hidden; /* Contain row overflow */
        }
        .row {
            margin-left: -10px;
            margin-right: -10px;
    ...
    /* ===== ACCESSIBILITY ===== */
    a, button, .dropdown-item { min-height: 44px; }
    .nav-sidebar > .nav-item > .nav-link { min-height: 46px; }
    .nav-treeview .nav-link { min-height: 38px !important; }
    :focus-visible {
    ...
    @media (max-width: 575.98px) {
        .sidebar-bg-fix { width: 260px; }
    }
    @media (max-width: 480px) {
        .sidebar-bg-fix { width: 240px; }
    }
    </style>
</head>
<body class="sidebar-mini layout-fixed" dir="<?= htmlspecialchars($uiDir, ENT_QUOTES, 'UTF-8') ?>" data-page="<?= htmlspecialchars($currentPage, ENT_QUOTES, 'UTF-8') ?>" data-perf-profile="<?= $isPerformanceCriticalPage ? 'critical' : 'default' ?>">
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" role="button" id="sidebarToggle" aria-label="القائمة" aria-controls="mainSidebar" aria-expanded="false">
                    <i class="fas fa-bars" style="font-size:20px;"></i>
                </a>
            </li>
            <!-- Notification Bell -->
            <li class="nav-item dropdown" id="notificationDropdown">
                <a class="nav-link notification-bell" data-toggle="dropdown" href="#" aria-label="الإشعارات" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-bell" style="font-size:20px;color:#6b7280;"></i>
                    <span class="notification-badge" id="notifBadge" style="display:none;" aria-live="polite">0</span>
                </a>
                <div class="dropdown-menu dropdown-menu-left notification-dropdown" style="width:320px;max-width:90vw;max-height:400px;overflow-y:auto;text-align:center !important;">
                    <div class="dropdown-header d-flex justify-content-between align-items-center" style="justify-content:center !important;text-align:center !important;">
                        <strong>الإشعارات</strong>
                        <a href="#" onclick="markAllNotificationsRead();return false;" class="text-primary small">تحديد الكل كمقروء</a>
                    </div>
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="<?= $User->userIsEmployee() ? 'ess-notifications' : 'admin-notifications' ?>" class="dropdown-item text-center text-primary" style="text-align:center !important;justify-content:center !important;display:flex !important;">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-left" style="text-align:center !important;">
                    <a href="<?= $User->userIsEmployee() ? 'ess-profile' : 'emp-info' ?>" class="dropdown-item" style="text-align:center !important; justify-content:center !important;"><i class="fas fa-user-circle"></i> الملف الشخصي</a>
                    <a href="<?= $User->userIsEmployee() ? 'ess-settings' : 'emp-setting' ?>" class="dropdown-item" style="text-align:center !important; justify-content:center !important;"><i class="fas fa-cog"></i> الإعدادات</a>
                    <div class="dropdown-divider"></div>
                    <a href="?logout=1" class="dropdown-item text-danger" style="text-align:center !important; justify-content:center !important;"><i class="fas fa-sign-out-alt"></i> تسجيل خروج</a>
                </div>
            </li>
        </ul>
    </nav>
    ...
    <aside class="main-sidebar elevation-4" id="mainSidebar">
        <a href="<?= $User->userIsEmployee() ? 'ess-dashboard' : 'employer-dashboard' ?>" class="brand-link">
            <img src="dist/img/brand/logo-secondary.png" alt="Vision HR" class="brand-logo" width="40" height="40" decoding="async" fetchpriority="high">
        </a>
        <div class="sidebar">
            <nav class="mt-1">
                <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="ess-dashboard" class="nav-link <?= ($page ?? '') == 'ess-dashboard' ? 'active' : '' ?>">
                            <i class="nav-icon fas fa-home"></i>
                            <p>لوحة المعلومات</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ess-attendance" class="nav-link <?= ($page ?? '') == 'ess-attendance' ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="ess-advances" class="nav-link <?= ($page ?? '') == 'ess-advances' ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="ess-documents" class="nav-link <?= ($page ?? '') == 'ess-documents' ? 'active' : '' ?>">
                            <i class="nav-icon fas fa-file-pdf"></i>
                            <p>المستندات والتقارير</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ess-policies" class="nav-link <?= ($page ?? '') == 'ess-policies' ? 'active' : '' ?>">
                            <i class="nav-icon fas fa-book"></i>
                            <p>سياسات الشركة</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ess-profile" class="nav-link <?= ($page ?? '') == 'ess-profile' ? 'active' : '' ?>">
                            <i class="nav-icon fas fa-id-badge"></i>
                            <p>ملفي الشخصي</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ess-settings" class="nav-link <?= ($page ?? '') == 'ess-settings' ? 'active' : '' ?>">
                    ...
                    <li class="nav-item">
                        <a href="employer-dashboard" class="nav-link <?= ($page ?? '') == 'employer-dashboard' ? 'active' : '' ?>">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"><a href="employer-list" class="nav-link"><i class="far fa-circle nav-icon"></i><p>قائمة الموظفين</p></a></li>
                            <li class="nav-item"><a href="employer-add" class="nav-link"><i class="far fa-circle nav-icon"></i><p>إضافة موظف</p></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"><a href="reveal-attendance" class="nav-link"><i class="far fa-circle nav-icon"></i><p>كشف الحضور</p></a></li>
                            <li class="nav-item"><a href="attendancet-emp" class="nav-link"><i class="far fa-circle nav-icon"></i><p>تسجيل الحضور</p></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"><a href="admin-leave-policies" class="nav-link"><i class="far fa-circle nav-icon"></i><p>سياسات الإجازات</p></a></li>
                            <li class="nav-item"><a href="admin-violations" class="nav-link"><i class="far fa-circle nav-icon"></i><p>إدارة المخالفات</p></a></li>
                            <li class="nav-item"><a href="admin-promotions" class="nav-link"><i class="far fa-circle nav-icon"></i><p>إدارة الترقيات</p></a></li>
                            <li class="nav-item"><a href="admin-workflows" class="nav-link"><i class="far fa-circle nav-icon"></i><p>سير العمل</p></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"><a href="admin-evaluations" class="nav-link"><i class="far fa-circle nav-icon"></i><p>تقييم الأداء</p></a></li>
                            <li class="nav-item"><a href="admin-rewards" class="nav-link"><i class="far fa-circle nav-icon"></i><p>المكافآت</p></a></li>
                            <li class="nav-item"><a href="admin-salary-ranges" class="nav-link"><i class="far fa-circle nav-icon"></i><p>نطاقات الرواتب</p></a></li>
                        </ul>
                    </li>

                    <li class="nav-item">
                        <a href="admin-approvals" class="nav-link <?= ($page ?? '') == 'admin-approvals' ? 'active' : '' ?>">
