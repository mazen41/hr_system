...
$page_title = 'اعدادات الموظفين';
 ...
 if (isset($_GET['id'])) {
    ...
    $query = "SELECT a.Id , a.UserID,a.DueDate,a.Status,a.Draft,a.Reason,a.type,
...
.bdanger{ border-right:0.3rem solid red; display:block;}
    ...
    echo 'رفع';
			...
			<div class="card-body p-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" id="main-info-tab" data-toggle="pill" href="#main-info" role="tab" aria-controls="main-info" aria-selected="true"><strong>التفاصيل</strong></a>
              </li>            
			</ul>
...
function confirm_check (id) {
	if(id !=''){
       ...
       if(type==1)
       {
			  $('#modal_default .modal-body').load('./hr-app/resignation-upload-add?id='+id+'',function(){
			});
    }
      else
      {
          $('#modal_default .modal-body').load('./hr-app/dismissal-upload?id='+id+'',function(){
			});
      }
		}
	}    
