    ...
    display: inline-block !important;
		...
		<div class="row">
            ...
            <div class="invoice p-3">
                ...
                <h1 class="h5">بيانات الاستقالات</h1>
...
function entriesData(is_date_search,branchs=[],date_range=''){
  ...
  var dataTable = $('#entries_tb').DataTable({
   ...
   "ajax" : {
	url:"hr-app/index.php?action=report-resignation",
	type:"POST",
	data:{
     ...
     buttons: [
         ...
         drawCallback: function (settings) {
           ...
           // $('#selected_client').html(settings.json.results_note.selected_client);
            $('#selected_client').html('<h5>استقالة '+$('#select2-client-container').text()+'</h5>');
             }else{
