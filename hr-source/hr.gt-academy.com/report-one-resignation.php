   <?php
if(!isset($_GET['id'])){
	echo'<script> location.replace("report-resignation"); </script>';
	die(); 
} 
$screen = 'الاستقالات';
$page_title = 'تفاصيل الاستقالات';
$report_name = 'تفاصيل الاستقالات';
...
$query = " SELECT a.Id ,a.UserID ,a.Status,a.LastUpdateDate, a.Draft,a.DueDate,
f.FirstName as f_name, f.LastName as l_name,b.branch_name,a.description
...
/* 
	...
	<?php endif;?>
        ...
        <div class="section">
            <div class="section-title">تقرير اسنقالة الموظف</div>
            <table>
                <thead>
                    <tr>
                        <th >#</th>
...
function printData() {
    ...
    body {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>تقرير استقالة الموظف</title>
                    ${styles}
                </head>
                <body>
                    ${printContents}
