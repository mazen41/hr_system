   <?php
if(!isset($_GET['id'])){
	echo'<script> location.replace("report-emplyements"); </script>';
	die(); 
} 
...
";
    ...
    if ($st->rowCount() > 0) {
        ...
        t.BranchID, t.SectionID, t.jobtitleID, t.GroupID, g.name as name_groub,t.GradeID,t.TypeID,
...
/* 
	...
	<?php endif;?>
			...
			<!-- start -->
                               ...
                               <div class="section">
            <div class="section-title">معلومات نمط العمل</div>
            <table>
                <tbody><tr>
                    <td style="width: 25%; font-weight: bold;"> اسم نمط العمل</td>
        ...
        <div class="section">
            <div class="section-title">المضافين في نمط العمل </div>
            <table>
                <thead>
                    <tr>
                        <th style="width: 5%;">#</th>
