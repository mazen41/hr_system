...
class Response
{
     ...
     */
    public static function tooManyRequests(int $retryAfter = 60, string $message = 'تم تجاوز عدد المحاولات المسموح به'): void
    {
     ...
     */
    public static function serverError(string $message = 'حدث خطأ في الخادم'): void
    {
