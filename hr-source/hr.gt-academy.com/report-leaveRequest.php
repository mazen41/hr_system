    ...
    display: inline-block !important;
		...
		<div class="row">
            ...
            <div class="invoice p-3">
                ...
                <h1 class="h5">بيانات الاجازات</h1>
...
entriesData('no');
function entriesData(is_date_search,branchs=[],date_range=''){
	//var account = 0;
	var groupColumn = 0;
  ...
  var dataTable = $('#entries_tb').DataTable({
   ...
   "ajax" : {
	url:"hr-app/index.php?action=report-leaveRequest",
	type:"POST",
	data:{
     ...
     buttons: [
         ...
         drawCallback: function (settings) {
           ...
           // $('#selected_client').html(settings.json.results_note.selected_client);
            $('#selected_client').html('<h5>أجازات الموظفين '+$('#select2-client-container').text()+'</h5>');
             }else{
...
//   $('#entries_tb').DataTable().destroy();
  entriesData('yes',branchs,date_range);
