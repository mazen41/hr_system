...
$screen = 'الاقسام';
$page_title = 'تفاصيل الاقسام ';
$report_name = 'تفاصيل الاقسام';
...
$query = "SELECT c.Id, c.Name, b.branch_name,c.CreatedBy,c.CreatedDate,
...
@page {
	...
	<?php endif;?>
			...
			<!-- start -->
                               ...
                               <div class="section">
            <div class="section-title">معلومات القسم</div>
            <table>
                <tbody><tr>
                    <td style="width: 25%; font-weight: bold;">اسم القسم</td>
        ...
        <div class="section">
            <div class="section-title">المضافين في هذا القسم</div>
            <table>
                <thead>
                    <tr>
                        <th style="width: 5%;">#</th>
