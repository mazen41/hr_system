...
// branches table doesn't have location columns — skip GPS fence for now
$row_loc = ['TypeBracnhLocation' => '', 'Onepoint' => '', 'MorePoint' => ''];

// Get today's attendance for current user
$today_att = [];
$att_q = $connect_pdo->prepare("SELECT Type, Time FROM attendancet WHERE EmpID = :uid AND Date = :d ORDER BY ID ASC");
...
function SendAttench()
{
    ...
    $.ajax({
	type: 'POST',
	url: "hr-app/index.php?action=Hrdashboard",
	dataType: "json",
