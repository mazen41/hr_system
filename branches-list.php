...
.filter-advance{
      ...
      <div class="container-fluid ">
        <div class="row ">
          ...
          <div class="col-5 text-left">	
			...
			<a href="branches-add" type="button" class="btn btn-success"  id="add-bt"><i class="fas fa-plus"></i><span class="d-none d-sm-inline"> إضافة فرع</span></a>
	...
	<?php endif;?>
				...
				<div class="table-responsive">
				   <table id="table_data" class="table dataTable table-hover  dtr-inline collapsed  nowrap display table-sm" width="100%">
                    <thead>
                     <tr class="bg-gry">
				...
				<div class="overlay"  style="display:none"><i class="fas fa-3x fa-sync-alt fa-spin"></i><div class="text-bold pt-2">جاري التحميل ...</div></div>
                </div>
                </div>
                <!-- /.col -->
              </div>
...
function getTableData()
{
  ...
  var dataTable = $('#table_data').DataTable({
   ...
   "ajax" : {
	...
	url:"./branches-app/branches-list",
	type:"POST",
	data:{}
   },
