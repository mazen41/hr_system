 <?php
if(!isset($_GET['id'])){
	echo'<script> location.replace("report-fingerprint"); </script>';
	die(); 
} 
$screen = 'الاقسام';
$page_title = 'تفاصيل المسميات الوظيفية ';
$report_name = 'تفاصيل المسميات الوظيفية';
...
//  u.FirstName , u.LastName,a.FingerprintType,a.FingerprintSerailnumber,a.ip,a.port
...
$query = "SELECT c.Id, c.Name, b.branch_name,c.CreatedBy,c.CreatedDate,u.FirstName , u.LastName
...
@page {
	...
	<?php endif;?>
			...
			<div class="card-body p-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" id="main-info-tab" data-toggle="pill" href="#main-info" role="tab" aria-controls="main-info" aria-selected="true"><strong>عن القسم</strong></a>
              </li>            
			</ul>
			...
			<!-- start -->
                               ...
                               <div class="section">
            <div class="section-title">معلومات المسمى الوظيفي</div>
            <table>
                <tbody><tr>
                    <td style="width: 25%; font-weight: bold;">اسم المسمى الوظيفي</td>
                ...
                <tr>
                    <td style="width: 25%; font-weight: bold;">تاريخ الانشاء</td>
                    <td style="width: 25%;"><?= !empty($row['CreatedDate'])?$row['CreatedDate']:'غير محدد' ?></td>
                    <td style="font-weight: bold;">اللي اضاف</td>
        ...
        <div class="section">
            <div class="section-title">المضافين في هذا المسمى الوظيفي</div>
            <table>
                <thead>
                    <tr>
                        <th style="width: 5%;">#</th>
...
function printData() {
    ...
    body {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>تقرير المسميات الوظيفية</title>
                    ${styles}
                </head>
                <body>
                    ${printContents}
