            ...
            },
            {
			  ...
			  render: function(data, type) {
                ...
                <?php if ($User->isAllowedPerm(['عرض ترقية'], $appid)) { ?>
                    options += '<a href="promotion-view?id=' + data.id + '" type="button" class="dropdown-item view-pos about_account"><i class="fa fa-eye"></i> عرض</a>';
                <?php } ?>

                <?php if ($User->isAllowedPerm(['تعديل ترقية'], $appid)) { ?>
                    options += '<a href="promotion-add?edit=' + data.id + '" type="button" class="dropdown-item"><i class="fa fa-edit"></i> تعديل</a>';
                <?php } ?>
