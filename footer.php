...
<!-- DataTable Responsive Helper -->
<script src="dist/js/datatable-responsive-helper.js?v=<?= time() ?>"></script>
    ...
    if(toggleBtn){
        ...
        var handleToggle = function(e){
            ...
            if(isMobile()){
                ...
                // Desktop: toggle sidebar width with dynamic content adjustment
                if(document.body) {
                    ...
                    if(isCollapsed) {
                        ...
                        if(contentWrapper) contentWrapper.style.marginRight = '270px';
                        if(navbar) {
                            navbar.style.marginRight = '270px';
                            navbar.style.width = 'calc(100% - 270px)';
                        }
                        if(footer) footer.style.marginRight = '270px';
                    } else {
                        // Collapsing sidebar
                        ...
                        if(footer) footer.style.marginRight = '0';
                    }
                }
            }
        };
...
<div class="pwa-install-banner" id="pwaInstallBanner">
    <div class="pwa-text">
        <img src="dist/img/brand/logo-icon.png" alt="Vision HR">
