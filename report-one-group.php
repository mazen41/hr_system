   <?php
if(!isset($_GET['id'])){
	echo'<script> location.replace("report-group"); </script>';
	die(); 
} 
$screen = 'المجموعات';
$page_title = 'تفاصيل المجموعات';
$report_name = 'تفاصيل المجموعات';
...
/* 
	...
	<?php endif;?>
			...
			<div class="card-body p-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" id="main-info-tab" data-toggle="pill" href="#main-info" role="tab" aria-controls="main-info" aria-selected="true"><strong>عن المجموعه</strong></a>
              </li>            
			</ul>
			...
			<!-- start -->
                               ...
                               <div class="section">
            <div class="section-title">معلومات المجموعه</div>
            <table>
                <tbody><tr>
                    <td style="width: 25%; font-weight: bold;"> اسم المجموعه</td>
        ...
        <div class="section">
            <div class="section-title">المضافين في هذه المجموعه</div>
            <table>
                <thead>
                    <tr>
                        <th style="width: 5%;">#</th>
