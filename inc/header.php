...
<head>
    ...
    <!-- Brand Identity CSS -->
    <link rel="stylesheet" href="dist/css/brand.css?v=<?= time() ?>">
    <!-- RTL/LTR Fixes -->
    <link rel="stylesheet" href="dist/css/rtl-fixes.css?v=<?= time() ?>">
    <!-- Tailwind Design System -->
    <link rel="stylesheet" href="dist/css/tailwind-design-system.css?v=<?= time() ?>">
    <!-- Global Responsive Overrides -->
    <link rel="stylesheet" href="dist/css/responsive-global.css?v=<?= time() ?>">
    <link rel="stylesheet" href="dist/css/ui-fixes-v3.css?v=<?= time() ?>">
    <!-- Comprehensive Responsive Fixes -->
    <link rel="stylesheet" href="dist/css/responsive-fixes.css?v=<?= time() ?>">

    <!-- Tailwind CSS (CDN) - preflight disabled to avoid conflicts with Bootstrap/AdminLTE) -->
    ...
    <!-- Global UX helpers (AJAX, RTL/LTR toggle, skeleton utilities) -->
    <script src="dist/js/app-ux.js?v=<?= time() ?>" defer></script>
    ...
    <script>
    (function() {
        console.log("VisionHR: Critical Fixes v6.0 Loaded");
    ...
    <link rel="stylesheet" href="dist/css/ess-enhanced.css?v=<?= time() ?>">
    <?php endif; ?>
    ...
    * { box-sizing: border-box; }
    ...
    .nav-sidebar > .nav-item > .nav-link {
        border-radius: 8px !important; /* Softer radius */
        padding: 10px 14px !important; /* refined padding */
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown" id="notificationDropdown">
                <a class="nav-link notification-bell" data-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-left notification-dropdown" style="width:320px;max-width:90vw;max-height:400px;overflow-y:auto;text-align:center !important;">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="<?= $User->userIsEmployee() ? 'ess-settings#notifications' : 'admin-notifications' ?>" class="dropdown-item text-center text-primary" style="text-align:center !important;justify-content:center !important;display:flex !important;">
